...
- [PR #28](https://github.com/CDCgov/MIRA-NF/pull/28) - Adding a custom_irma_config flag that allows user to pass a custom irma config to be passed to the pipeline for IRMA assembly.
