...
```bash
nextflow run cdcgov/mira-nf --input ./samplesheet.csv --outdir ./results  -profile docker
```
...
```bash
nextflow run cdcgov/mira-nf -profile docker -params-file params.yaml
```
